  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <View style={styles.content}>
        ...
        <Text style={[type.body, { marginTop: 8, marginBottom: 32, lineHeight: 22 }]}>
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 28, fontWeight: '800', color: colors.black, letterSpacing: -0.5, lineHeight: 36, marginTop: 8 },
  inputRow: {
  ...
  flag: { fontSize: 18 },
  code: { fontSize: 14, fontWeight: '700', color: colors.black },
  ...
  terms: { ...type.small, textAlign: 'center', lineHeight: 18 },
});
