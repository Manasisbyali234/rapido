...
const styles = StyleSheet.create({
  ...
  header: { backgroundColor: colors.yellow, paddingTop: 60, paddingBottom: 24, paddingHorizontal: 20, borderBottomLeftRadius: 24, borderBottomRightRadius: 24 },
  total: { fontSize: 32, fontWeight: '900', color: colors.black, marginTop: 4 },
  ...
  barLabel: { fontSize: 11, color: colors.grey, fontWeight: '600' },
